...
@endpush
@else
<aside id="confirm_order" class="order-cart-dock gray-black shadow-0" aria-label="Order List">
	<div class="order-cart-dock__bar d-flex align-items-center px-3 py-2">
		<h2 class="h5 mb-0 text-white fw-600 text-capitalize flex-fill">Order List</h2>
	</div>
